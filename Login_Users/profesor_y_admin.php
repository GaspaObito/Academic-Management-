...
<div class="bienvenido">
    <div class="bienvenido__login">
        <h1 id="TitleStart" style="text-align: unset;">BIENVENIDO</h1>
        <p>Por favor ingrese los siguientes datos para iniciar sesión como profesor</p>
        <form class="Form_Acudiente" action="../Config/auth/conectar_RegistroUsuario.php" method="post">
            <div class="login">
                <div class="contacto">
                    <svg class="img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        version="1.1" id="Capa_1" x="0px" y="0px" width="40" height="40" viewBox="0 0 510 510"
                ...
                <input class="Input_Text" type="text" name="Correo" placeholder="E-mal">
            </div>
            <div class="login">
                <div class="contacto">
                    <svg class="img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        version="1.1" id="Capa_1" width="40" height="40" viewBox="0 0 516.375 516.375"
                ...
                <input class="Input_Text" type="text" name="Contrasena" placeholder="Constraseña">
            </div>
    ...
    <div class="bonito">
        ...
        <div>
            <div class="contacto">
                <svg class="img" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-phone-call"
